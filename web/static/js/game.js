...
var Game = {
    ...
    cursor: 'url(/sprites/hand.png), auto', // image of the mouse cursor in normal circumstances
    talkCursor: 'url(/sprites/talk.png), auto', // image of the cursor when hovering NPC
    lootCursor: 'url(/sprites/loot.png), auto', // image of cursors when hovering loot
    fightCursor: 'url(/sprites/sword.png), auto', // image of cursor when hovering monster
